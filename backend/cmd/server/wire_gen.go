...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	muleRunGatewayService := service.NewMuleRunGatewayService(httpUpstream)
	vendorMediaService := service.NewVendorMediaService(httpUpstream)
	muleRunGatewayHandler := handler.NewMuleRunGatewayHandler(muleRunGatewayService, vendorMediaService, gatewayService, usageService, usageRecordWorkerPool)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, muleRunGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, idempotencyCoordinator, idempotencyCleanupService)
