...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'mulerun'
...
const BADGE: Record<Platform, string> = {
  ...
  mulerun: 'bg-gray-500/10 text-gray-600 border-gray-500/30 dark:text-gray-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  mulerun: 'bg-gray-500/10 text-gray-600 dark:bg-gray-500/10 dark:text-gray-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  mulerun: 'border-gray-500/20 dark:border-gray-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  mulerun: 'bg-gradient-to-r from-gray-400 to-gray-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  mulerun: 'text-gray-600 dark:text-gray-400',
}
...
const ICON: Record<Platform, string> = {
  ...
  mulerun: 'text-gray-500 dark:text-gray-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  mulerun: 'bg-gray-500 text-white hover:bg-gray-600 active:bg-gray-700 dark:bg-gray-500/80 dark:hover:bg-gray-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  mulerun: 'bg-gray-100 text-gray-700 dark:bg-gray-900/40 dark:text-gray-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  mulerun: 'from-gray-500 to-gray-600',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'mulerun'
}
