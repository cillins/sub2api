    ...
    <TablePageLayout>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-usage_mulerun="{ row }">
            <PlatformCostCell :usage="getPlatformUsage(row.id, 'mulerun')" />
          </template>
...
const allColumns = computed<Column[]>(() => [
  ...
  { key: 'usage_mulerun', label: t('admin.users.columns.usageMuleRun'), sortable: false },
...
const DEFAULT_HIDDEN_COLUMNS = [
  ...
  'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_mulerun',
...
const USAGE_COLUMN_KEYS: readonly string[] = ['usage', 'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_mulerun']
